...
<body>
    ...
    <div class="page-wrapper">
        <div class="page-card">
            ...
            <div class="status-badge">Không tìm thấy</div>

            <h1 class="page-title">Trang bạn tìm kiếm không tồn tại</h1>
            <p class="page-desc">Trang này có thể đã bị xóa, đổi tên hoặc tạm thời không khả dụng. Hãy kiểm tra lại đường dẫn hoặc quay về trang chủ.</p>

            <div class="btn-group">
                <a href="https://marketroblox.com/" class="action-btn">
...
<script type="module" src="https://static.cloudflareinsights.com/beacon.min.js/v4513226cdae34746b4dedf0b4dfa099e1781791509496" integrity="sha512-ZE9pZaUXND66v380QUtch/5sE9tPFh2zg45pR2PB0CVkCtOREv2AJKkSidISWkysEuQ0EH8faUU5du78bx87UQ==" data-cf-beacon='{"version":"2024.11.0","token":"8bbdf6304cdd407cbe1c0c7e1a8cc7e2","r":1}' crossorigin="anonymous"></script>
</body>
